...
public class myserver
{
	...
	public myserver()
	{
		try
		{
		al=new ArrayList(); //duplicate elements in insertion order
		al1=new ArrayList();
		...
		while(true)
		{
			...
			al.add(s);
			Runnable r=new mythread(s,al); //upcasting
	...
	class mythread implements Runnable
	{
		...
		public void run()
		{
			...
			try
			{
				...
				do
				{
					s1=din.readUTF(); //unicode text format-8
					if(s1.startsWith("*"))
					{
					...
					else if(s1.startsWith("("))
					{
						...
						//passing message to all clients
